...
static const struct fg_batt_profile bqfs_image[] = {
	{ bqfs_atl, ARRAY_SIZE(bqfs_atl), 5 },//30
...
static irqreturn_t fg_irq_thread(int irq, void *dev_id)
{
	...
	pr_err("itpor=%d, cfg_mode = %d, seal_state=%d, batt_present=%d",
							...
							const struct i2c_device_id *id)
{
	...
	pr_err("The fuel gauge probe start \n");
	...
	pr_err("The fuel gauge probe success!\n");
...
err_1:
	...
	pr_err("The fuel gauge probe fail \n");
	return ret;
}
