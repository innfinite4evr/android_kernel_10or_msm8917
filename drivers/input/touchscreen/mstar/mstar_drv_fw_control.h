...
typedef enum {
	...
	#ifdef CONFIG_S502_BOARD_SUPPORT  	//add DJ by xiongshaohua 
    MSG28XX_SW_ID_YYYY = 0x0008,   //帝京参数8
	#else
	MSG28XX_SW_ID_YYYY = 0x0002,		
	#endif                        //end DJ by xiongshaohua 
...
extern void DrvFwCtrlMsg28xxReadEFlashStart(u16 nStartAddr, EmemType_e eEmemType);
extern void DrvFwCtrlMsg28xxReadEFlashDoRead(u16 nReadAddr, u8 *pReadData);
extern void DrvFwCtrlMsg28xxReadEFlashEnd(void);
