...
#define SELF_IC_OPEN_TEST_NON_BORDER_AREA_THRESHOLD (40) // range : 25~60
#define SELF_IC_OPEN_TEST_BORDER_AREA_THRESHOLD     (45) // range : 25~60

#define	SELF_IC_SHORT_TEST_THRESHOLD                8000//(3500)
