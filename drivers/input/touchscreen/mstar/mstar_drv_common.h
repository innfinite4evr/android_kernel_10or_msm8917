...
#define DEVICE_DRIVER_RELEASE_VERSION   ("5.2.0.0")
...
/*
 * Note.
 * The below compile option is used to enable segment read debug mode finger touch data for MSG26XXM/MSG28XX/MSG58XX/MSG58XXA only.
 * Since I2C transaction length limitation for some specific MTK BB chip(EX. MT6589/MT6572/...) or QCOM BB chip, the debug mode finger touch data of MSG26XXM/MSG28XX/MSG58XX/MSG58XXA can not be retrieved by one time I2C read operation.  
 ...
 * By the way, force touch is supported for MSG28XX/MSG58XX/MSG58XXA only, but is not supported for MSG26XXM/MSG21XXA/MSG22XX yet.
 * By default, this compile option is disabled.
 */
...
#define MAX_UPDATE_FIRMWARE_BUFFER_SIZE    (130) // 130KB. The size shall be large enough for stored any kind firmware size of MSG21XXA(33KB)/MSG22XX(48.5KB)/MSG26XXM(40KB)/MSG28XX(130KB)/MSG58XX(130KB)/MSG58XXA(130KB).
