...
static DEVICE_ATTR(batch, 0660, sensors_batch_show, sensors_batch_store);
...
static const struct attribute_group *sensor_dev_groups[]={
         &sensor_group,
         NULL,
 ...
 */
 ...
 static int __init sensors_init(void)
 {
    ...
    sensors_class->dev_groups = sensor_dev_groups;
 	return 0;
 }
